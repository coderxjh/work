...
public class AppConstant {
     ...
     * 企业内部应用的唯一身份标识
     */
    public static final String APP_KEY = "dinggep68hlomyx98tk0";
    /**
     * 开发者后台->应用开发-企业内部应用->选择您的小程序->凭证与基础信息->AppSecret
     * 对应的调用密钥
     */
    public static final String APP_SECRET="sX8gyU8tICqsZWZbgR6PXn1RQSgJb9o0c-81GCI1VqVG1yRDhWAJyMfx2Mgx7g0l";
//    /**
